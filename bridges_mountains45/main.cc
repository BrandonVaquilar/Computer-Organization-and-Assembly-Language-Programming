...
extern "C" { void asm_findpath(int *img_arr, int imgWidth, int imgHeight, int startRow, int maxVal);}

int main(int argc, char **argv) {
	int bridges_project_id = 302; //901;
    string bridges_username = "BrandonV";
    string bridges_api_key  = "880903452940";
	//static_assert(false,"Please enter your username and apikey above, and then delete this line.");
	...
	//FIXME findPath (elev_data, width, height, startRow, maxVal);
	//extern "C" {
	//	asm_bridges();
	//}
		asm_findpath(elev_data, width, height, startRow, maxVal);
